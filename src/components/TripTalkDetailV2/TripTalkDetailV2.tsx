...
import styles from './TripTalkDetailV2.module.css'
import type { TripTalk, Comment } from '../../data/tripTalks'

interface TripTalkDetailV2Props {
  post: TripTalk
  onBack: () => void
}

export default function TripTalkDetailV2({ post, onBack }: TripTalkDetailV2Props) {
        ...
        <div className={styles.postSection}>
          <div className={styles.header}>
            ...
            <div className={styles.profileInfo}>
              ...
              <div className={styles.metaRow}>
                ...
                <span className={styles.metaText}>{post.category}</span>
                <span className={styles.metaDot} />
                <span className={styles.metaText}>{post.region}</span>
              </div>
            </div>
          </div>
          ...
          <div className={styles.actionRow}>
            <div className={styles.actionLeft}>
              ...
              <button className={styles.actionBtn} aria-label={`댓글 ${post.commentCount}`}>
                <span className={styles.actionIcon}>
                  <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
            ...
            <div key={comment.id} className={styles.comment}>
              <div className={styles.commentHeader}>
                <img
                  ...
                  src={`https://i.pravatar.cc/56?u=${comment.userName}`}
              ...
              <div className={styles.commentActions}>
                <button
                  ...
                  data-liked={commentLikes[comment.id]}
                ...
                {comment.isMine && (
                  <button className={styles.commentActionBtn}>삭제</button>
                )}
              </div>
                    ...
                    <div key={reply.id} className={styles.reply}>
                      <div className={styles.replyHeader}>
                        <img
                          ...
                          src={`https://i.pravatar.cc/40?u=${reply.userName}`}
